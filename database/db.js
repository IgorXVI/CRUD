...
const db = new Database('database/data.db',  { verbose: log })
log("Conectado ao banco de dados SQLite database/data.db")
...
process.on('exit', () =>{
    db.close()
    log("A conexão com o banco de dados SQLite database/data.db foi fechada.")
